...
public final class BookingServiceSoap_BookingServiceSoap12_Client {
    private static final QName SERVICE_NAME = new QName("http://tempuri.org/", "BookingService");

    private BookingServiceSoap_BookingServiceSoap12_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        BookingServiceSoap port = ss.getBookingServiceSoap12();
        {
