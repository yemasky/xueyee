...
@XmlSeeAlso({
        pms.PMSGateway.ArrayOfRequiredPaymentsTypeGuaranteePayment.GuaranteePayment.AmountPercent.class,
        pms.PMSGateway.RequiredPaymentsType.GuaranteePayment.AmountPercent.class
})
