...
@XmlSeeAlso({
        pms.PMSGateway.CustomerType.Email.class,
        pms.PMSGateway.CompanyInfoType.Email.class,
        pms.PMSGateway.ArrayOfEmailsTypeEmail.Email.class,
        pms.PMSGateway.RailPassengerDetailType.Email.class
})
