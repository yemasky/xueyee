...
@XmlSeeAlso({
        pms.PMSGateway.OTAPrdReadRQ.ReadRequests.UserID.class,
        pms.PMSGateway.OTAReadRQ.ReadRequests.UserID.class,
        pms.PMSGateway.ArrayOfRoomStaysTypeRoomStay.RoomStay.Reference.class,
        pms.PMSGateway.ProfileType.UserID.class,
        pms.PMSGateway.VehicleSegmentCoreType.ConfID.class,
        pms.PMSGateway.VehicleReservationSummaryType.ConfID.class,
        ReservationIDType.class,
        pms.PMSGateway.SourceType.RequestorID.class
})
