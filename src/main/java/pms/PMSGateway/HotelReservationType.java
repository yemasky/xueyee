...
@XmlSeeAlso({
        pms.PMSGateway.OTANotifReportRQ.NotifDetails.HotelNotifReport.HotelReservations.HotelReservation.class,
        pms.PMSGateway.OTAPrdNotifReportRQ.NotifDetails.HotelNotifReport.HotelReservations.HotelReservation.class
})
