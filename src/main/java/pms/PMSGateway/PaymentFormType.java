...
@XmlSeeAlso({
        pms.PMSGateway.CustomerType.PaymentForm.class,
        HotelPaymentFormType.class,
        PaymentDetailType.class,
        PaymentResponseType.class,
        pms.PMSGateway.CompanyInfoType.PaymentForm.class,
        pms.PMSGateway.ArrayOfGuaranteeTypeGuaranteeAccepted.GuaranteeAccepted.class
})
