...
@XmlSeeAlso({
        pms.order.ArrayOfSpecialRequestTypeSpecialRequest.SpecialRequest.class,
        DescriptionType.class,
        pms.order.ArrayOfProfileTypeComment.Comment.class,
        pms.order.ArrayOfCommentTypeComment.Comment.class
})
