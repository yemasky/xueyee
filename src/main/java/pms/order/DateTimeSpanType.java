...
@XmlType(name = "DateTimeSpanType", propOrder = {
        "endDateWindowOrStartDateWindowOrDateWindowRange"
})
@XmlSeeAlso({
        pms.order.ResCommonDetailType.TimeSpan.class
})
public class DateTimeSpanType {
    ...
    protected List<Object> endDateWindowOrStartDateWindowOrDateWindowRange;
    ...
    /**
     * Gets the value of the endDateWindowOrStartDateWindowOrDateWindowRange property.
     * <p/>
     * <p/>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the endDateWindowOrStartDateWindowOrDateWindowRange property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEndDateWindowOrStartDateWindowOrDateWindowRange().add(newItem);
     * </pre>
     * <p/>
     * <p/>
     * <p/>
     ...
     */
    public List<Object> getEndDateWindowOrStartDateWindowOrDateWindowRange() {
        if (endDateWindowOrStartDateWindowOrDateWindowRange == null) {
            endDateWindowOrStartDateWindowOrDateWindowRange = new ArrayList<Object>();
        }
        return this.endDateWindowOrStartDateWindowOrDateWindowRange;
    }
