 ...
 * 2017-01-10T11:18:00.080+08:00
 * Generated source version: 2.7.10
 */
@WebServiceClient(name = "Service",
        wsdlLocation = "http://localhost:48363/Service.asmx?WSDL",
...
public class Service extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:48363/Service.asmx?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Service.class.getName())
                    .log(java.util.logging.Level.INFO,
                            "Can not initialize the default wsdl from {0}", "http://localhost:48363/Service.asmx?WSDL");
        }
        WSDL_LOCATION = url;
    }
