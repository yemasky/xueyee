...
@XmlSeeAlso({
    ota.jw.AvailRes.CustomerType.Address.class,
    ota.jw.AvailRes.CompanyInfoType.AddressInfo.class,
    ota.jw.AvailRes.ArrayOfRequiredPaymentsTypeGuaranteePayment.GuaranteePayment.Address.class
})
