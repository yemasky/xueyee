...
@XmlSeeAlso({
    ota.jw.AvailRes.OTAHotelAvailRS.RoomStays.RoomStay.Reference.class,
    ota.jw.AvailRes.SourceType.RequestorID.class,
    ReservationIDType.class,
    ota.jw.AvailRes.ProfileType.UserID.class
})
