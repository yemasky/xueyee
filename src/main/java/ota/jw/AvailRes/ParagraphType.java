...
@XmlSeeAlso({
    ...
    ota.jw.AvailRes.ArrayOfProfileTypeComment.Comment.class,
    ota.jw.AvailRes.ArrayOfCommentTypeComment.Comment.class,
    ota.jw.AvailRes.ArrayOfSpecialRequestTypeSpecialRequest.SpecialRequest.class
})
