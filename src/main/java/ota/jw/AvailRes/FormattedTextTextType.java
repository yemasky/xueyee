...
@XmlSeeAlso({
    ...
    ota.jw.AvailRes.TextDescriptionType.Description.class,
    ota.jw.AvailRes.ImageDescriptionType.Description.class,
    ota.jw.AvailRes.ParagraphType.ListItem.class
})
