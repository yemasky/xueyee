...
/**
 * <p>RelatedTravelerType complex type的 Java 类。
 * 
...
@XmlSeeAlso({
    ota.jw.PMSGateway.CruiseGuestDetailType.LinkedTraveler.class,
    ota.jw.PMSGateway.ArrayOfCruiseGuestInfoTypeLinkedBooking.LinkedBooking.class
})
