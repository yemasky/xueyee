...
@XmlSeeAlso({
    ...
    ota.jw.PMSGateway.ArrayOfCommentTypeComment.Comment.class,
    ota.jw.PMSGateway.ArrayOfSpecialRequestTypeSpecialRequest.SpecialRequest.class,
    ota.jw.PMSGateway.ArrayOfProfileTypeComment.Comment.class,
    ota.jw.PMSGateway.ArrayOfAffiliationInfoTypeLoyalProgram.LoyalProgram.ProgramDescription.class,
    ota.jw.PMSGateway.ArrayOfAffiliationInfoTypeLoyalProgram.LoyalProgram.ProgramRestriction.class
})
