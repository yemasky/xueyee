...
@XmlSeeAlso({
    ota.jw.PMSGateway.HotelInfoType.Descriptions.MultimediaDescriptions.class,
    ota.jw.PMSGateway.RestaurantType.MultimediaDescriptions.class,
    ota.jw.PMSGateway.AreaInfoType.Recreations.Recreation.MultimediaDescriptions.class
})
