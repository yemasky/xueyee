...
@XmlSeeAlso({
    ota.jw.PMSGateway.OTAReadRQ.ReadRequests.UserID.class,
    ota.jw.PMSGateway.OTAPrdReadRQ.ReadRequests.UserID.class,
    ota.jw.PMSGateway.SourceType.RequestorID.class,
    ReservationIDType.class,
    ota.jw.PMSGateway.ArrayOfRoomStaysTypeRoomStay.RoomStay.Reference.class,
    ota.jw.PMSGateway.ProfileType.UserID.class,
    ota.jw.PMSGateway.VehicleReservationSummaryType.ConfID.class,
    ota.jw.PMSGateway.VehicleSegmentCoreType.ConfID.class
})
