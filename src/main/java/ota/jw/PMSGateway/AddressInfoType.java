...
@XmlSeeAlso({
    ota.jw.PMSGateway.ArrayOfRequiredPaymentsTypeGuaranteePayment.GuaranteePayment.Address.class,
    ota.jw.PMSGateway.CompanyInfoType.AddressInfo.class,
    ota.jw.PMSGateway.ArrayOfAddressesTypeAddress.Address.class,
    ota.jw.PMSGateway.RequiredPaymentsType.GuaranteePayment.Address.class,
    ota.jw.PMSGateway.CustomerType.Address.class
})
