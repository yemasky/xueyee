...
@XmlSeeAlso({
    ota.jw.PMSGateway.CustomerPrimaryAdditionalType.Primary.class,
    ota.jw.PMSGateway.CustomerPrimaryAdditionalType.Additional.class
})
public class CustomerType {
    ...
    public static class Telephone {
        ...
        /**
         * 获取phoneLocationTypeSpecified属性的值。
         * 
         */
        ...
        /**
         * 设置phoneLocationTypeSpecified属性的值。
         * 
         */
