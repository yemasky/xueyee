...
@XmlSeeAlso({
    ...
    ota.jw.PMSGateway.ArrayOfGuaranteeTypeGuaranteeAccepted.GuaranteeAccepted.class,
    ota.jw.PMSGateway.CompanyInfoType.PaymentForm.class,
    ota.jw.PMSGateway.CustomerType.PaymentForm.class
})
