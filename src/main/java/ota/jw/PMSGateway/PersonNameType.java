...
@XmlSeeAlso({
    ota.jw.PMSGateway.VerificationType.PersonName.class,
    ota.jw.PMSGateway.OrganizationType.OrgMemberName.class,
    ota.jw.PMSGateway.TravelClubType.ClubMemberName.class,
    ota.jw.PMSGateway.ArrayOfContactsTypeName.Name.class
})
