...
@XmlSeeAlso({
    ota.jw.PMSGateway.CompanyInfoType.Email.class,
    ota.jw.PMSGateway.RailPassengerDetailType.Email.class,
    ota.jw.PMSGateway.ArrayOfEmailsTypeEmail.Email.class,
    ota.jw.PMSGateway.CustomerType.Email.class
})
