...
@XmlSeeAlso({
    ...
    ota.jw.PMSGateway.ImageDescriptionType.Description.class,
    ota.jw.PMSGateway.TextDescriptionType.Description.class,
    ota.jw.PMSGateway.ParagraphType.ListItem.class,
    ota.jw.PMSGateway.ArrayOfRateQualifierTypeRateComment.RateComment.class
})
