 ...
 *       &lt;/sequence&gt;
 *       &lt;attribute name="CurrencyCode" type="{http://www.w3.org/2001/XMLSchema}nonNegativeInteger" /&gt;
 *       &lt;attribute name="CurrencyCodeSpecified" use="required" type="{http://www.w3.org/2001/XMLSchema}boolean" /&gt;
...
@XmlSeeAlso({
    ota.jw.PMSGateway.ArrayOfRequiredPaymentsTypeGuaranteePayment.GuaranteePayment.AmountPercent.class,
    ota.jw.PMSGateway.RequiredPaymentsType.GuaranteePayment.AmountPercent.class
})
public class AmountPercentType {
    ...
    @XmlAttribute(name = "CurrencyCodeSpecified", required = true)
    protected boolean currencyCodeSpecified;
    ...
    /**
     * 获取currencyCodeSpecified属性的值。
     * 
     */
    public boolean isCurrencyCodeSpecified() {
        return currencyCodeSpecified;
    }

    /**
     * 设置currencyCodeSpecified属性的值。
     * 
     */
    public void setCurrencyCodeSpecified(boolean value) {
