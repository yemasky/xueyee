 ...
 *         &lt;element name="ClientName" type="{http://www.opentravel.org/OTA/2003/05}ClientNameType" minOccurs="0"/&gt;
 ...
 *       &lt;attribute name="EarlyArrivalTime" type="{http://www.w3.org/2001/XMLSchema}dateTime" /&gt;
 *       &lt;attribute name="LastArrivalTime" type="{http://www.w3.org/2001/XMLSchema}dateTime" /&gt;
...
public class ResGuestType {
    ...
    protected XMLGregorianCalendar earlyArrivalTime;
    @XmlAttribute(name = "LastArrivalTime")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar lastArrivalTime;
     ...
     *     
     */
    public XMLGregorianCalendar getEarlyArrivalTime() {
     ...
     *     
     */
    public void setEarlyArrivalTime(XMLGregorianCalendar value) {
     ...
     *     
     */
    public XMLGregorianCalendar getLastArrivalTime() {
     ...
     *     
     */
    public void setLastArrivalTime(XMLGregorianCalendar value) {
