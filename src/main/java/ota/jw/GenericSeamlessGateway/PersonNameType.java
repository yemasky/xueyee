...
@XmlSeeAlso({
    ota.jw.GenericSeamlessGateway.DonationType.DonorInfo.Name.class,
    ota.jw.GenericSeamlessGateway.OrganizationType.OrgMemberName.class,
    ota.jw.GenericSeamlessGateway.TravelClubType.ClubMemberName.class
})
