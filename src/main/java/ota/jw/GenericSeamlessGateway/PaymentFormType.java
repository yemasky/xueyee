...
@XmlSeeAlso({
    ota.jw.GenericSeamlessGateway.ArrayOfGuaranteeTypeGuaranteeAccepted.GuaranteeAccepted.class,
    HotelPaymentFormType.class,
    PaymentDetailType.class,
    PaymentResponseType.class,
    ota.jw.GenericSeamlessGateway.CustomerType.PaymentForm.class,
    ota.jw.GenericSeamlessGateway.CompanyInfoType.PaymentForm.class
})
