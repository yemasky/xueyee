...
@XmlSeeAlso({
    ...
    ota.jw.GenericSeamlessGateway.ArrayOfCommentTypeComment.Comment.class,
    ota.jw.GenericSeamlessGateway.ArrayOfSpecialRequestTypeSpecialRequest.SpecialRequest.class,
    ota.jw.GenericSeamlessGateway.ArrayOfProfileTypeComment.Comment.class
})
public class ParagraphType {
    ...
    protected List<JAXBElement<?>> urlOrImageOrText;
    ...
    /**
     * Gets the value of the urlOrImageOrText property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the urlOrImageOrText property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getURLOrImageOrText().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getURLOrImageOrText() {
        if (urlOrImageOrText == null) {
            urlOrImageOrText = new ArrayList<JAXBElement<?>>();
        }
        return this.urlOrImageOrText;
    }
