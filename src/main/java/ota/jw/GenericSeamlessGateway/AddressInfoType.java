...
@XmlSeeAlso({
    ota.jw.GenericSeamlessGateway.ArrayOfRequiredPaymentsTypeGuaranteePayment.GuaranteePayment.Address.class,
    ota.jw.GenericSeamlessGateway.CustomerType.Address.class,
    ota.jw.GenericSeamlessGateway.CompanyInfoType.AddressInfo.class
})
