...
@XmlSeeAlso({
    ...
    ota.jw.ARIPmsGateway.ParagraphType.ListItem.class,
    ota.jw.ARIPmsGateway.ImageDescriptionType.Description.class,
    ota.jw.ARIPmsGateway.TextDescriptionType.Description.class
})
