...
@XmlSeeAlso({
    ota.jw.ARIPmsGateway.ArrayOfGuaranteeTypeGuaranteeAccepted.GuaranteeAccepted.class,
    PaymentDetailType.class,
    HotelPaymentFormType.class,
    PaymentResponseType.class,
    ota.jw.ARIPmsGateway.CustomerType.PaymentForm.class,
    ota.jw.ARIPmsGateway.CompanyInfoType.PaymentForm.class
})
